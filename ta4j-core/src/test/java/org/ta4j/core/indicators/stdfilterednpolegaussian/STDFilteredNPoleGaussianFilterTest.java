...
public class STDFilteredNPoleGaussianFilterTest {
  ...
  public void testIndicator() throws ParseException {
    ...
    Assert.assertEquals(expBuys(), findOperationByTipe(operations, OperationType.BUY));
    Assert.assertEquals(expSells(), findOperationByTipe(operations, OperationType.SELL));
  }
  ...
  private List<Operation> findOperationByTipe(final List<Operation> operations, final OperationType buy) {
